...
def go_dependencies():
    ...
    go_repository(
        ...
        sum = "h1:BXiqvN7WuV/pMhz8CivhO8cG8icJcjnjHumif4ukQ0c=",
        version = "v1.3.37",
    )
    ...
    go_repository(
        ...
        sum = "h1:9+XBTxnj49bcW16NFNsr/yBUkY/+zumt07nWuDoVyvY=",
        version = "v0.0.0-20230728181735-20c51a9f425d",
    )
    go_repository(
    ...
    go_repository(
        ...
        sum = "h1:QrzfX26snvCM20hIhBwuHI/ThTg18b/+kcKdXHvnR+g=",
        version = "v0.9.0",
    )
