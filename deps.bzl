...
def go_dependencies():
    ...
    go_repository(
        ...
        sum = "h1:Jv0E28xDkke3KrWle90yOLtBmZsUqXLBy70lZRfbKN0=",
        version = "v0.1.3",
    )
    go_repository(
    ...
    go_repository(
        name = "com_github_gioui_uax",
        importpath = "github.com/gioui/uax",
        sum = "h1:ro1W5kY1pVBLHy4GokZUfr9cl7ewZhAiT5WsXqFDYE4=",
        version = "v0.2.1-0.20220819135011-cda973fac06d",
    )
    go_repository(
    ...
    go_repository(
        ...
        sum = "h1:WINlj3ANt+CVrO2B4NGDHRlPvEWZPxjhb7z+JKypwXI=",
        version = "v0.0.0-20220411150340-35994bc27a7b",
    )
    go_repository(
    ...
    go_repository(
        ...
        sum = "h1:Z+rFdxVW6zFSMwJ7Q9C8XCdPFT8ZQgfSySZ/d6jQbDM=",
        version = "v0.0.0-20221116222243-5c84cf7e9021",
    )
    go_repository(
        name = "org_gioui_cpu",
    ...
    go_repository(
        ...
        sum = "h1:klJAUGTRrnTvp2+ongrNqLxrl/415DPs2iR9xn/k0ME=",
